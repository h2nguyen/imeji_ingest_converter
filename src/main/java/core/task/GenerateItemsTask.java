 ...
 *
 */
public class GenerateItemsTask extends SwingWorker<String,Void> {
	...
	public GenerateItemsTask(String inputFilename, JProgressBar progressBar, JLabel lblNotification) {		
		this(inputFilename, getOutputFilename(inputFilename), progressBar, lblNotification);
	}

	public GenerateItemsTask(String inputFilename, String outputFilename, JProgressBar progressBar, JLabel lblNotification) {
