 ...
 *
 */
public class GenerateZuseMergedMetadataProfileTask extends SwingWorker<String,Void> {
	...
	public GenerateZuseMergedMetadataProfileTask(String inputFilename1, String inputFilename2, JProgressBar progressBar, JLabel lblNotification) {		
		this(inputFilename1, inputFilename2 , getOutputFilename(inputFilename1), progressBar, lblNotification);
	}

	public GenerateZuseMergedMetadataProfileTask(String inputFilename1, String inputFilename2, String outputFilename, JProgressBar progressBar, JLabel lblNotification) {
